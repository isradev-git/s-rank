...
| [1.1](fase-1.1-esqueleto.md) | Esqueleto web: navegación, diseño, login, registro y PWA | **en curso** — desplegada y verificada en producción; falta probarla instalada en el móvil |
